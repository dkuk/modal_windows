...
Samples:
* __link_to_modal_window__('Show modal with dynamic loaded content', {:controller => 'docflow_versions', :action=> 'autocomplete_for_user', :q => ''}) - default modal - disappears on mouseleave or mouseclick.
* __link_to_modal_window__('Show permanent', "Test Permanent window", {:modal_type => 'permanent'}) - permanent static modal. Can be closed via button.
