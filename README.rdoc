...
Samples:
* __link_to_modal_window('Show modal with dynamic loaded content', {:controller => 'docflow_versions', :action=> 'autocomplete_for_user', :q => ''})__ - default modal - disappears on mouseleave or mouseclick.
* __link_to_modal_window('Show permanent', "Test Permanent window", {:modal_type => 'permanent'})__ - permanent static modal. Can be closed via button.
